...
wire   [0:0] icmp_ln887_fu_290_p2;
wire   [0:0] icmp_ln887_1_fu_295_p2;
wire    ap_CS_fsm_state12;
reg   [0:0] icmp_ln887_1_reg_505;
wire   [0:0] icmp_ln887_2_fu_338_p2;
wire    ap_CS_fsm_state13;
reg   [0:0] icmp_ln879_reg_476;
reg   [0:0] icmp_ln887_2_reg_514;
reg    l1_V_blk_n_AR;
wire   [0:0] initialized_V_load_load_fu_215_p1;
reg    l1_V_blk_n_R;
...
reg   [0:0] icmp_ln879_1_reg_528;
reg   [0:0] icmp_ln883_reg_550;
...
reg   [0:0] initialized_V_load_reg_445;
reg   [31:0] l1_V_addr_1_read_reg_466;
wire   [3:0] task_in_ttype_V_load_fu_255_p4;
reg   [3:0] task_in_ttype_V_load_reg_471;
wire    ap_CS_fsm_state10;
wire   [0:0] icmp_ln879_fu_264_p2;
wire   [31:0] grp_fu_199_p4;
wire   [32:0] ret_V_fu_274_p2;
reg   [32:0] ret_V_reg_491;
wire   [31:0] v_V_fu_280_p2;
reg   [31:0] v_V_reg_496;
reg    ap_predicate_op86_write_state11;
reg    ap_predicate_op94_write_state11;
reg    ap_block_state11_io;
wire  signed [135:0] sext_ln177_fu_328_p1;
wire  signed [135:0] sext_ln177_1_fu_367_p1;
wire   [31:0] grp_fu_208_p2;
reg    ap_block_state12_io;
wire   [0:0] icmp_ln879_1_fu_372_p2;
reg    ap_predicate_op99_write_state13;
reg    ap_block_state13_io;
reg  signed [31:0] base_flags_V_load_reg_532;
reg   [31:0] l1_V_addr_2_reg_537;
reg   [31:0] current_flag_V_reg_544;
wire   [0:0] icmp_ln883_fu_405_p2;
wire    ap_CS_fsm_state22;
wire   [29:0] add_ln1503_fu_422_p2;
reg   [29:0] add_ln1503_reg_554;
reg    ap_block_state24_io;
reg   [31:0] total_v_V_loc_0_reg_179;
wire   [31:0] ap_phi_mux_child_object_V_phi_fu_192_p4;
reg   [31:0] child_object_V_reg_189;
wire  signed [63:0] sext_ln544_fu_395_p1;
reg    ap_predicate_op133_writeresp_state29;
...
wire   [63:0] p_Result_s_fu_304_p5;
reg   [31:0] grp_fu_208_p0;
wire   [32:0] zext_ln115_fu_270_p1;
wire   [32:0] zext_ln887_fu_286_p1;
wire   [131:0] tmp_fu_316_p5;
wire   [63:0] p_Result_1_fu_343_p5;
wire   [63:0] trunc_ln176_fu_354_p1;
wire   [131:0] tmp_1_fu_357_p4;
wire  signed [31:0] lhs_V_fu_381_p0;
wire  signed [33:0] lhs_V_fu_381_p1;
wire   [33:0] rhs_V_fu_385_p1;
wire   [33:0] ret_V_1_fu_389_p2;
wire   [29:0] trunc_ln1503_fu_410_p1;
wire   [29:0] tmp_5_fu_413_p4;
reg   [28:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state10) & (icmp_ln879_fu_264_p2 == 1'd1))) begin
        child_object_V_reg_189 <= {{task_in[99:68]}};
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state10) & (initialized_V_load_reg_445 == 1'd0))) begin
        total_v_V_loc_0_reg_179 <= l1_V_addr_1_read_reg_466;
    end else if ((~((1'b1 == ap_block_state1_io) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1) & (initialized_V_load_load_fu_215_p1 == 1'd1))) begin
        total_v_V_loc_0_reg_179 <= total_v_V;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state22) & (icmp_ln883_fu_405_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state13_io) & (1'b1 == ap_CS_fsm_state13) & (icmp_ln879_1_fu_372_p2 == 1'd1))) begin
        base_flags_V_load_reg_532 <= base_flags_V;
        l1_V_addr_2_reg_537 <= sext_ln544_fu_395_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        ...
        task_in_ttype_V_load_reg_471 <= {{task_in[67:64]}};
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state11_io) & (1'b1 == ap_CS_fsm_state11) & (icmp_ln887_fu_290_p2 == 1'd1))) begin
        icmp_ln887_1_reg_505 <= icmp_ln887_1_fu_295_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state11_io) & (1'b1 == ap_CS_fsm_state11) & (icmp_ln887_fu_290_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state11_io) & (1'b1 == ap_CS_fsm_state11) & (icmp_ln887_1_fu_295_p2 == 1'd1) & (icmp_ln887_fu_290_p2 == 1'd1))) begin
        p_Val2_s_fu_108 <= p_Result_s_fu_304_p5;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state10) & (icmp_ln879_fu_264_p2 == 1'd1))) begin
...
always @ (*) begin
    if ((~((regslice_both_undo_log_entry_V_U_apdone_blk == 1'b1) | (regslice_both_task_out_V_U_apdone_blk == 1'b1) | ((ap_predicate_op133_writeresp_state29 == 1'b1) & (l1_V_BVALID == 1'b0))) & (1'b1 == ap_CS_fsm_state29))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((~((regslice_both_undo_log_entry_V_U_apdone_blk == 1'b1) | (regslice_both_task_out_V_U_apdone_blk == 1'b1) | ((ap_predicate_op133_writeresp_state29 == 1'b1) & (l1_V_BVALID == 1'b0))) & (ap_predicate_op133_writeresp_state29 == 1'b1) & (1'b1 == ap_CS_fsm_state29))) begin
        l1_V_BREADY = 1'b1;
    end else begin
        l1_V_BREADY = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state29) & (icmp_ln879_1_reg_528 == 1'd1) & (icmp_ln883_reg_550 == 1'd0))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state13) & (icmp_ln887_2_reg_514 == 1'd1) & (icmp_ln879_reg_476 == 1'd1)) | ((1'b1 == ap_CS_fsm_state12) & (icmp_ln887_1_reg_505 == 1'd1)) | ((1'b1 == ap_CS_fsm_state11) & (icmp_ln887_2_fu_338_p2 == 1'd1) & (icmp_ln887_fu_290_p2 == 1'd0)) | ((1'b1 == ap_CS_fsm_state11) & (icmp_ln887_1_fu_295_p2 == 1'd1) & (icmp_ln887_fu_290_p2 == 1'd1)))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        if ((ap_predicate_op94_write_state11 == 1'b1)) begin
            task_out_V_TDATA_int = sext_ln177_1_fu_367_p1;
        end else if ((ap_predicate_op86_write_state11 == 1'b1)) begin
...
always @ (*) begin
    if ((((ap_predicate_op94_write_state11 == 1'b1) & (1'b0 == ap_block_state11_io) & (1'b1 == ap_CS_fsm_state11)) | ((ap_predicate_op86_write_state11 == 1'b1) & (1'b0 == ap_block_state11_io) & (1'b1 == ap_CS_fsm_state11)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((1'b1 == ap_block_state1_io) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1) & (initialized_V_load_load_fu_215_p1 == 1'd1))) begin
        ...
        ap_ST_fsm_state11 : begin
            if (((1'b0 == ap_block_state11_io) & (1'b1 == ap_CS_fsm_state11) & (icmp_ln887_fu_290_p2 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_state13;
            end else if (((1'b0 == ap_block_state11_io) & (1'b1 == ap_CS_fsm_state11) & (icmp_ln887_fu_290_p2 == 1'd1))) begin
        ...
        ap_ST_fsm_state13 : begin
            if (((1'b0 == ap_block_state13_io) & (1'b1 == ap_CS_fsm_state13) & (icmp_ln879_1_fu_372_p2 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_state29;
            end else if (((1'b0 == ap_block_state13_io) & (1'b1 == ap_CS_fsm_state13) & (icmp_ln879_1_fu_372_p2 == 1'd1))) begin
        ...
        ap_ST_fsm_state22 : begin
            if (((1'b1 == ap_CS_fsm_state22) & (icmp_ln883_fu_405_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state29;
            end else begin
        ...
        ap_ST_fsm_state25 : begin
            if (((undo_log_entry_V_TREADY_int == 1'b1) & (1'b1 == ap_CS_fsm_state25))) begin
...
assign add_ln1503_fu_422_p2 = (trunc_ln1503_fu_410_p1 + tmp_5_fu_413_p4);
...
always @ (*) begin
    ap_block_state12_io = ((task_out_V_TREADY_int == 1'b0) & (icmp_ln887_1_reg_505 == 1'd1));
end
...
always @ (*) begin
    ap_block_state24_io = ((undo_log_entry_V_TREADY_int == 1'b0) | (l1_V_WREADY == 1'b0));
end

always @ (*) begin
    ap_block_state29 = ((regslice_both_undo_log_entry_V_U_apdone_blk == 1'b1) | (regslice_both_task_out_V_U_apdone_blk == 1'b1) | ((ap_predicate_op133_writeresp_state29 == 1'b1) & (l1_V_BVALID == 1'b0)));
end

assign ap_phi_mux_child_object_V_phi_fu_192_p4 = child_object_V_reg_189;

always @ (*) begin
    ap_predicate_op133_writeresp_state29 = ((icmp_ln879_1_reg_528 == 1'd1) & (icmp_ln883_reg_550 == 1'd0));
end

always @ (*) begin
    ap_predicate_op86_write_state11 = ((icmp_ln887_1_fu_295_p2 == 1'd1) & (icmp_ln887_fu_290_p2 == 1'd1));
end

always @ (*) begin
    ap_predicate_op94_write_state11 = ((icmp_ln887_2_fu_338_p2 == 1'd1) & (icmp_ln887_fu_290_p2 == 1'd0));
end

always @ (*) begin
    ap_predicate_op99_write_state13 = ((icmp_ln887_2_reg_514 == 1'd1) & (icmp_ln879_reg_476 == 1'd1));
end
...
assign grp_fu_199_p4 = {{task_in[99:68]}};

assign grp_fu_208_p2 = (grp_fu_208_p0 + 32'd1);

assign icmp_ln879_1_fu_372_p2 = ((task_in_ttype_V_load_reg_471 == 4'd1) ? 1'b1 : 1'b0);

assign icmp_ln879_fu_264_p2 = ((task_in_ttype_V_load_fu_255_p4 == 4'd0) ? 1'b1 : 1'b0);

assign icmp_ln883_fu_405_p2 = ((current_flag_V_reg_544 == 32'd2) ? 1'b1 : 1'b0);

assign icmp_ln887_1_fu_295_p2 = ((child_object_V_reg_189 < total_v_V_loc_0_reg_179) ? 1'b1 : 1'b0);

assign icmp_ln887_2_fu_338_p2 = ((v_V_reg_496 < total_v_V_loc_0_reg_179) ? 1'b1 : 1'b0);

assign icmp_ln887_fu_290_p2 = ((zext_ln887_fu_286_p1 < ret_V_reg_491) ? 1'b1 : 1'b0);

assign initialized_V_load_load_fu_215_p1 = initialized_V;

assign lhs_V_fu_381_p0 = base_flags_V;

assign lhs_V_fu_381_p1 = lhs_V_fu_381_p0;

assign p_Result_1_fu_343_p5 = {{ap_const_lv64_0[63:32]}, {v_V_reg_496}};

assign p_Result_s_fu_304_p5 = {{p_Val2_s_fu_108[63:32]}, {child_object_V_reg_189}};

assign ret_V_1_fu_389_p2 = ($signed(lhs_V_fu_381_p1) + $signed(rhs_V_fu_385_p1));

assign ret_V_fu_274_p2 = (zext_ln115_fu_270_p1 + 33'd7);

assign rhs_V_fu_385_p1 = grp_fu_199_p4;

assign sext_ln177_1_fu_367_p1 = $signed(tmp_1_fu_357_p4);

assign sext_ln177_fu_328_p1 = $signed(tmp_fu_316_p5);

assign sext_ln544_fu_395_p1 = $signed(ret_V_1_fu_389_p2);

assign task_in_ttype_V_load_fu_255_p4 = {{task_in[67:64]}};

assign task_out_V_TVALID = regslice_both_task_out_V_U_vld_out;

assign tmp_1_fu_357_p4 = {{{p_Result_1_fu_343_p5}, {4'd0}}, {trunc_ln176_fu_354_p1}};

assign tmp_5_fu_413_p4 = {{task_in[97:68]}};

assign tmp_fu_316_p5 = {{{{p_Result_s_fu_304_p5}, {4'd2}}, {child_object_V_reg_189}}, {grp_fu_208_p2}};

assign trunc_ln1503_fu_410_p1 = base_flags_V_load_reg_532[29:0];

assign trunc_ln176_fu_354_p1 = task_in[63:0];

assign undo_log_entry_V_TDATA_int = {{{current_flag_V_reg_544}, {add_ln1503_reg_554}}, {2'd0}};

assign undo_log_entry_V_TVALID = regslice_both_undo_log_entry_V_U_vld_out;

assign v_V_fu_280_p2 = (grp_fu_199_p4 + 32'd7);

assign zext_ln115_fu_270_p1 = grp_fu_199_p4;

assign zext_ln887_fu_286_p1 = child_object_V_reg_189;
