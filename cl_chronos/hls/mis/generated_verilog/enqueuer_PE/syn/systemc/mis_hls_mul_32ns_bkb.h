...
// ==============================================================
#ifndef __mis_hls_mul_32ns_bkb__HH__
#define __mis_hls_mul_32ns_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mis_hls_mul_32ns_bkb) {
    ...
    SC_CTOR(mis_hls_mul_32ns_bkb):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
