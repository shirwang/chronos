...
const sc_lv<34> mis_hls::ap_ST_fsm_state1 = "1";
const sc_lv<34> mis_hls::ap_ST_fsm_state2 = "10";
const sc_lv<34> mis_hls::ap_ST_fsm_state3 = "100";
const sc_lv<34> mis_hls::ap_ST_fsm_state4 = "1000";
const sc_lv<34> mis_hls::ap_ST_fsm_state5 = "10000";
const sc_lv<34> mis_hls::ap_ST_fsm_state6 = "100000";
const sc_lv<34> mis_hls::ap_ST_fsm_state7 = "1000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state8 = "10000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state9 = "100000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state10 = "1000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state11 = "10000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state12 = "100000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state13 = "1000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state14 = "10000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state15 = "100000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state16 = "1000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state17 = "10000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state18 = "100000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state19 = "1000000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state20 = "10000000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state21 = "100000000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state22 = "1000000000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state23 = "10000000000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state24 = "100000000000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state25 = "1000000000000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state26 = "10000000000000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state27 = "100000000000000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state28 = "1000000000000000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state29 = "10000000000000000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state30 = "100000000000000000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state31 = "1000000000000000000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state32 = "10000000000000000000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state33 = "100000000000000000000000000000000";
const sc_lv<34> mis_hls::ap_ST_fsm_state34 = "1000000000000000000000000000000000";
...
const sc_lv<32> mis_hls::ap_const_lv32_12 = "10010";
const sc_lv<32> mis_hls::ap_const_lv32_21 = "100001";
...
const sc_lv<32> mis_hls::ap_const_lv32_11 = "10001";
...
const sc_lv<32> mis_hls::ap_const_lv32_10 = "10000";
...
const sc_lv<32> mis_hls::ap_const_lv32_13 = "10011";
...
mis_hls::mis_hls(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    mis_hls_mul_32ns_bkb_U1->din0(grp_fu_364_p0);
    mis_hls_mul_32ns_bkb_U1->din1(grp_fu_364_p1);
    mis_hls_mul_32ns_bkb_U1->ce(grp_fu_364_ce);
    mis_hls_mul_32ns_bkb_U1->dout(grp_fu_364_p2);
    ...
    SC_METHOD(thread_add_ln544_1_fu_415_p2);
    sensitive << ( ret_V_2_reg_582 );
    sensitive << ( sext_ln544_3_fu_412_p1 );

    SC_METHOD(thread_add_ln544_fu_406_p2);
    sensitive << ( sext_ln544_1_fu_398_p1 );
    sensitive << ( sext_ln544_2_fu_402_p1 );
    ...
    sensitive << ( initialized_V_load_reg_478 );
    sensitive << ( l1_V_RVALID );

    SC_METHOD(thread_ap_block_state19_io);
    sensitive << ( ap_predicate_op124_write_state19 );
    ...
    sensitive << ( icmp_ln887_1_reg_559 );
    sensitive << ( task_out_V_TREADY_int );

    SC_METHOD(thread_ap_block_state34_io);
    sensitive << ( ap_predicate_op154_write_state34 );
    sensitive << ( task_out_V_TREADY_int );
    ...
    SC_METHOD(thread_ap_predicate_op124_write_state19);
    sensitive << ( icmp_ln887_fu_346_p2 );
    sensitive << ( icmp_ln887_2_fu_372_p2 );

    SC_METHOD(thread_ap_predicate_op154_write_state34);
    sensitive << ( icmp_ln879_reg_500 );
    sensitive << ( icmp_ln887_2_reg_573 );
    ...
    SC_METHOD(thread_child_ts_V_fu_369_p1);
    sensitive << ( task_in );

    SC_METHOD(thread_empty_8_fu_320_p2);
    sensitive << ( ap_CS_fsm_state18 );
    sensitive << ( l1_V_RVALID );
    sensitive << ( zext_ln177_1_fu_314_p1 );
    sensitive << ( empty_fu_317_p1 );

    SC_METHOD(thread_empty_9_fu_326_p2);
    sensitive << ( start_n_V_reg_516 );

    SC_METHOD(thread_empty_fu_317_p1);
    sensitive << ( start_n_V_reg_516 );
    ...
    SC_METHOD(thread_i_V_fu_305_p4);
    sensitive << ( task_in );
    ...
    sensitive << ( initialized_V_load_reg_478 );
    sensitive << ( l1_V_RVALID );
    sensitive << ( task_in_ttype_V_load_fu_234_p4 );

    SC_METHOD(thread_icmp_ln887_1_fu_351_p2);
    sensitive << ( ap_CS_fsm_state19 );
    sensitive << ( icmp_ln887_fu_346_p2 );
    sensitive << ( n_V_reg_534 );
    sensitive << ( ap_block_state19_io );
    sensitive << ( t_V_reg_175 );

    SC_METHOD(thread_icmp_ln887_2_fu_372_p2);
    sensitive << ( ap_CS_fsm_state19 );
    sensitive << ( icmp_ln887_fu_346_p2 );
    sensitive << ( n_V_reg_534 );
    sensitive << ( ngh_cnt_V_reg_545 );
    sensitive << ( ap_block_state19_io );

    SC_METHOD(thread_icmp_ln887_fu_346_p2);
    sensitive << ( ap_CS_fsm_state19 );
    sensitive << ( zext_ln177_1_reg_540 );
    sensitive << ( ap_block_state19_io );
    sensitive << ( sext_ln887_fu_342_p1 );

    SC_METHOD(thread_initialized_V_load_load_fu_185_p1);
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( initialized_V );
    ...
    sensitive << ( l1_V_addr_3_reg_510 );
    sensitive << ( l1_V_addr_4_reg_592 );
    ...
    SC_METHOD(thread_lhs_V_2_fu_338_p1);
    sensitive << ( i_V_fu_305_p4 );

    SC_METHOD(thread_lhs_V_fu_262_p1);
    sensitive << ( base_degree_V );

    SC_METHOD(thread_ngh_cnt_V_1_fu_462_p2);
    sensitive << ( t_V_reg_175 );

    SC_METHOD(thread_ngh_cnt_V_fu_331_p3);
    sensitive << ( start_n_V_reg_516 );
    sensitive << ( empty_8_fu_320_p2 );
    sensitive << ( empty_9_fu_326_p2 );

    SC_METHOD(thread_p_Result_s_fu_429_p5);
    sensitive << ( l1_V_RDATA );
    sensitive << ( p_Val2_s_fu_98 );

    SC_METHOD(thread_ret_V_1_fu_299_p2);
    sensitive << ( zext_ln177_fu_295_p1 );

    SC_METHOD(thread_ret_V_fu_270_p2);
    sensitive << ( lhs_V_fu_262_p1 );
    sensitive << ( rhs_V_fu_266_p1 );

    SC_METHOD(thread_rhs_V_fu_266_p1);
    sensitive << ( vid_V_fu_249_p4 );

    SC_METHOD(thread_sext_ln177_1_fu_389_p1);
    sensitive << ( tmp_1_fu_379_p5 );

    SC_METHOD(thread_sext_ln177_fu_452_p1);
    sensitive << ( tmp_fu_441_p5 );

    SC_METHOD(thread_sext_ln544_1_fu_398_p1);
    sensitive << ( base_neighbor_V );

    SC_METHOD(thread_sext_ln544_2_fu_402_p1);
    sensitive << ( t_V_reg_175 );

    SC_METHOD(thread_sext_ln544_3_fu_412_p1);
    sensitive << ( add_ln544_reg_587 );

    SC_METHOD(thread_sext_ln544_fu_276_p1);
    sensitive << ( ret_V_fu_270_p2 );

    SC_METHOD(thread_sext_ln887_fu_342_p1);
    sensitive << ( t_V_reg_175 );

    SC_METHOD(thread_start_n_V_fu_286_p4);
    sensitive << ( task_in );

    SC_METHOD(thread_task_in_ttype_V_load_fu_234_p4);
    sensitive << ( task_in );
    ...
    sensitive << ( l1_V_RVALID );
    sensitive << ( ap_predicate_op124_write_state19 );
    sensitive << ( sext_ln177_1_fu_389_p1 );
    sensitive << ( sext_ln177_fu_452_p1 );
    ...
    SC_METHOD(thread_tmp_1_fu_379_p5);
    sensitive << ( i_V_reg_529 );
    sensitive << ( ngh_cnt_V_reg_545 );
    sensitive << ( trunc_ln176_fu_376_p1 );

    SC_METHOD(thread_tmp_fu_441_p5);
    sensitive << ( l1_V_RDATA );
    sensitive << ( child_ts_V_reg_568 );
    sensitive << ( p_Result_s_fu_429_p5 );

    SC_METHOD(thread_trunc_ln176_fu_376_p1);
    sensitive << ( task_in );
    ...
    SC_METHOD(thread_vid_V_fu_249_p4);
    sensitive << ( task_in );

    SC_METHOD(thread_zext_ln177_1_fu_314_p1);
    sensitive << ( ret_V_1_reg_524 );

    SC_METHOD(thread_zext_ln177_fu_295_p1);
    sensitive << ( start_n_V_fu_286_p4 );
    ...
    sensitive << ( icmp_ln887_fu_346_p2 );
    sensitive << ( ap_CS_fsm_state34 );
    sensitive << ( initialized_V_load_load_fu_185_p1 );
    sensitive << ( ap_CS_fsm_state8 );
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( ap_CS_fsm_state9 );
    sensitive << ( ap_CS_fsm_state3 );
    ...
    sensitive << ( icmp_ln887_1_fu_351_p2 );
    sensitive << ( ap_block_state19_io );
    ...
    sc_trace(mVcdFile, icmp_ln887_1_reg_559, "icmp_ln887_1_reg_559");
    sc_trace(mVcdFile, ap_CS_fsm_state19, "ap_CS_fsm_state19");
    sc_trace(mVcdFile, icmp_ln887_fu_346_p2, "icmp_ln887_fu_346_p2");
    sc_trace(mVcdFile, icmp_ln887_2_fu_372_p2, "icmp_ln887_2_fu_372_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state34, "ap_CS_fsm_state34");
    sc_trace(mVcdFile, icmp_ln879_reg_500, "icmp_ln879_reg_500");
    sc_trace(mVcdFile, icmp_ln887_2_reg_573, "icmp_ln887_2_reg_573");
    sc_trace(mVcdFile, l1_V_blk_n_AR, "l1_V_blk_n_AR");
    sc_trace(mVcdFile, initialized_V_load_load_fu_185_p1, "initialized_V_load_load_fu_185_p1");
    ...
    sc_trace(mVcdFile, initialized_V_load_reg_478, "initialized_V_load_reg_478");
    ...
    sc_trace(mVcdFile, l1_V_addr_3_reg_510, "l1_V_addr_3_reg_510");
    sc_trace(mVcdFile, start_n_V_fu_286_p4, "start_n_V_fu_286_p4");
    sc_trace(mVcdFile, start_n_V_reg_516, "start_n_V_reg_516");
    sc_trace(mVcdFile, ap_CS_fsm_state17, "ap_CS_fsm_state17");
    sc_trace(mVcdFile, ret_V_1_fu_299_p2, "ret_V_1_fu_299_p2");
    sc_trace(mVcdFile, ret_V_1_reg_524, "ret_V_1_reg_524");
    sc_trace(mVcdFile, i_V_fu_305_p4, "i_V_fu_305_p4");
    sc_trace(mVcdFile, i_V_reg_529, "i_V_reg_529");
    sc_trace(mVcdFile, n_V_reg_534, "n_V_reg_534");
    sc_trace(mVcdFile, zext_ln177_1_fu_314_p1, "zext_ln177_1_fu_314_p1");
    sc_trace(mVcdFile, zext_ln177_1_reg_540, "zext_ln177_1_reg_540");
    sc_trace(mVcdFile, ngh_cnt_V_fu_331_p3, "ngh_cnt_V_fu_331_p3");
    sc_trace(mVcdFile, ngh_cnt_V_reg_545, "ngh_cnt_V_reg_545");
    sc_trace(mVcdFile, lhs_V_2_fu_338_p1, "lhs_V_2_fu_338_p1");
    sc_trace(mVcdFile, lhs_V_2_reg_551, "lhs_V_2_reg_551");
    sc_trace(mVcdFile, icmp_ln887_1_fu_351_p2, "icmp_ln887_1_fu_351_p2");
    sc_trace(mVcdFile, ap_predicate_op124_write_state19, "ap_predicate_op124_write_state19");
    sc_trace(mVcdFile, ap_block_state19_io, "ap_block_state19_io");
    sc_trace(mVcdFile, child_ts_V_fu_369_p1, "child_ts_V_fu_369_p1");
    sc_trace(mVcdFile, child_ts_V_reg_568, "child_ts_V_reg_568");
    sc_trace(mVcdFile, sext_ln177_1_fu_389_p1, "sext_ln177_1_fu_389_p1");
    sc_trace(mVcdFile, grp_fu_364_p2, "grp_fu_364_p2");
    sc_trace(mVcdFile, ret_V_2_reg_582, "ret_V_2_reg_582");
    sc_trace(mVcdFile, ap_CS_fsm_state23, "ap_CS_fsm_state23");
    sc_trace(mVcdFile, add_ln544_fu_406_p2, "add_ln544_fu_406_p2");
    sc_trace(mVcdFile, add_ln544_reg_587, "add_ln544_reg_587");
    sc_trace(mVcdFile, l1_V_addr_4_reg_592, "l1_V_addr_4_reg_592");
    sc_trace(mVcdFile, ap_CS_fsm_state24, "ap_CS_fsm_state24");
    sc_trace(mVcdFile, sext_ln177_fu_452_p1, "sext_ln177_fu_452_p1");
    sc_trace(mVcdFile, ngh_cnt_V_1_fu_462_p2, "ngh_cnt_V_1_fu_462_p2");
    sc_trace(mVcdFile, ap_block_state33_io, "ap_block_state33_io");
    sc_trace(mVcdFile, t_V_reg_175, "t_V_reg_175");
    sc_trace(mVcdFile, sext_ln544_fu_276_p1, "sext_ln544_fu_276_p1");
    sc_trace(mVcdFile, add_ln544_1_fu_415_p2, "add_ln544_1_fu_415_p2");
    sc_trace(mVcdFile, p_Val2_s_fu_98, "p_Val2_s_fu_98");
    sc_trace(mVcdFile, p_Result_s_fu_429_p5, "p_Result_s_fu_429_p5");
    sc_trace(mVcdFile, task_in_ttype_V_load_fu_234_p4, "task_in_ttype_V_load_fu_234_p4");
    sc_trace(mVcdFile, vid_V_fu_249_p4, "vid_V_fu_249_p4");
    sc_trace(mVcdFile, lhs_V_fu_262_p1, "lhs_V_fu_262_p1");
    sc_trace(mVcdFile, rhs_V_fu_266_p1, "rhs_V_fu_266_p1");
    sc_trace(mVcdFile, ret_V_fu_270_p2, "ret_V_fu_270_p2");
    sc_trace(mVcdFile, zext_ln177_fu_295_p1, "zext_ln177_fu_295_p1");
    sc_trace(mVcdFile, empty_fu_317_p1, "empty_fu_317_p1");
    sc_trace(mVcdFile, empty_8_fu_320_p2, "empty_8_fu_320_p2");
    sc_trace(mVcdFile, empty_9_fu_326_p2, "empty_9_fu_326_p2");
    sc_trace(mVcdFile, sext_ln887_fu_342_p1, "sext_ln887_fu_342_p1");
    sc_trace(mVcdFile, grp_fu_364_p0, "grp_fu_364_p0");
    sc_trace(mVcdFile, grp_fu_364_p1, "grp_fu_364_p1");
    sc_trace(mVcdFile, trunc_ln176_fu_376_p1, "trunc_ln176_fu_376_p1");
    sc_trace(mVcdFile, tmp_1_fu_379_p5, "tmp_1_fu_379_p5");
    sc_trace(mVcdFile, sext_ln544_1_fu_398_p1, "sext_ln544_1_fu_398_p1");
    sc_trace(mVcdFile, sext_ln544_2_fu_402_p1, "sext_ln544_2_fu_402_p1");
    sc_trace(mVcdFile, sext_ln544_3_fu_412_p1, "sext_ln544_3_fu_412_p1");
    sc_trace(mVcdFile, tmp_fu_441_p5, "tmp_fu_441_p5");
    ...
    sc_trace(mVcdFile, ap_predicate_op154_write_state34, "ap_predicate_op154_write_state34");
...
void mis_hls::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state33.read()) && 
        ...
        t_V_reg_175 = ngh_cnt_V_1_fu_462_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state18.read()) && 
                esl_seteq<1,1,1>(l1_V_RVALID.read(), ap_const_logic_1))) {
        t_V_reg_175 = start_n_V_reg_516.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state23.read())) {
        add_ln544_reg_587 = add_ln544_fu_406_p2.read();
        ret_V_2_reg_582 = grp_fu_364_p2.read();
    }
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state19.read()) && esl_seteq<1,1,1>(ap_block_state19_io.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln887_fu_346_p2.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln887_1_fu_351_p2.read()))) {
        child_ts_V_reg_568 = child_ts_V_fu_369_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state18.read()) && esl_seteq<1,1,1>(l1_V_RVALID.read(), ap_const_logic_1))) {
        i_V_reg_529 = task_in.read().range(131, 100);
        lhs_V_2_reg_551 = lhs_V_2_fu_338_p1.read();
        n_V_reg_534 = l1_V_RDATA.read();
        ngh_cnt_V_reg_545 = ngh_cnt_V_fu_331_p3.read();
        zext_ln177_1_reg_540 = zext_ln177_1_fu_314_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read()) && !(esl_seteq<1,1,1>(ap_const_lv1_0, initialized_V_load_reg_478.read()) && esl_seteq<1,1,1>(ap_const_logic_0, l1_V_RVALID.read())))) {
        icmp_ln879_reg_500 = icmp_ln879_fu_243_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state19.read()) && esl_seteq<1,1,1>(ap_block_state19_io.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln887_fu_346_p2.read()))) {
        icmp_ln887_1_reg_559 = icmp_ln887_1_fu_351_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state19.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln887_fu_346_p2.read()) && esl_seteq<1,1,1>(ap_block_state19_io.read(), ap_const_boolean_0))) {
        icmp_ln887_2_reg_573 = icmp_ln887_2_fu_372_p2.read();
    }
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state1_io.read())))) {
        initialized_V_load_reg_478 = initialized_V.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read()) && !(esl_seteq<1,1,1>(ap_const_lv1_0, initialized_V_load_reg_478.read()) && esl_seteq<1,1,1>(ap_const_logic_0, l1_V_RVALID.read())) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln879_fu_243_p2.read()))) {
        l1_V_addr_3_reg_510 =  (sc_lv<32>) (sext_ln544_fu_276_p1.read());
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state24.read())) {
        l1_V_addr_4_reg_592 =  (sc_lv<32>) (add_ln544_1_fu_415_p2.read());
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state32.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, l1_V_RVALID.read()) || esl_seteq<1,1,1>(ap_const_logic_0, task_out_V_TREADY_int.read())))) {
        p_Val2_s_fu_98 = p_Result_s_fu_429_p5.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state17.read())) {
        ret_V_1_reg_524 = ret_V_1_fu_299_p2.read();
        start_n_V_reg_516 = task_in.read().range(99, 68);
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, initialized_V_load_reg_478.read()) && !(esl_seteq<1,1,1>(ap_const_lv1_0, initialized_V_load_reg_478.read()) && esl_seteq<1,1,1>(ap_const_logic_0, l1_V_RVALID.read())))) {
        total_v_V = l1_V_RDATA.read();
    }
}

void mis_hls::thread_add_ln544_1_fu_415_p2() {
    add_ln544_1_fu_415_p2 = (!ret_V_2_reg_582.read().is_01() || !sext_ln544_3_fu_412_p1.read().is_01())? sc_lv<64>(): (sc_biguint<64>(ret_V_2_reg_582.read()) + sc_bigint<64>(sext_ln544_3_fu_412_p1.read()));
}

void mis_hls::thread_add_ln544_fu_406_p2() {
    add_ln544_fu_406_p2 = (!sext_ln544_1_fu_398_p1.read().is_01() || !sext_ln544_2_fu_402_p1.read().is_01())? sc_lv<33>(): (sc_bigint<33>(sext_ln544_1_fu_398_p1.read()) + sc_bigint<33>(sext_ln544_2_fu_402_p1.read()));
}
...
void mis_hls::thread_ap_CS_fsm_state17() {
    ap_CS_fsm_state17 = ap_CS_fsm.read()[16];
}

void mis_hls::thread_ap_CS_fsm_state18() {
    ap_CS_fsm_state18 = ap_CS_fsm.read()[17];
}

void mis_hls::thread_ap_CS_fsm_state19() {
...
void mis_hls::thread_ap_CS_fsm_state20() {
...
void mis_hls::thread_ap_CS_fsm_state33() {
    ap_CS_fsm_state33 = ap_CS_fsm.read()[32];
}

void mis_hls::thread_ap_CS_fsm_state34() {
...
void mis_hls::thread_ap_block_state10() {
    ap_block_state10 = (esl_seteq<1,1,1>(ap_const_lv1_0, initialized_V_load_reg_478.read()) && esl_seteq<1,1,1>(ap_const_logic_0, l1_V_RVALID.read()));
}

void mis_hls::thread_ap_block_state19_io() {
    ap_block_state19_io = (esl_seteq<1,1,1>(ap_const_boolean_1, ap_predicate_op124_write_state19.read()) && esl_seteq<1,1,1>(ap_const_logic_0, task_out_V_TREADY_int.read()));
}
...
void mis_hls::thread_ap_block_state33_io() {
    ap_block_state33_io = (esl_seteq<1,1,1>(icmp_ln887_1_reg_559.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_0, task_out_V_TREADY_int.read()));
}

void mis_hls::thread_ap_block_state34_io() {
    ap_block_state34_io = (esl_seteq<1,1,1>(ap_const_boolean_1, ap_predicate_op154_write_state34.read()) && esl_seteq<1,1,1>(ap_const_logic_0, task_out_V_TREADY_int.read()));
}
...
void mis_hls::thread_ap_predicate_op124_write_state19() {
    ap_predicate_op124_write_state19 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln887_fu_346_p2.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln887_2_fu_372_p2.read()));
}

void mis_hls::thread_ap_predicate_op154_write_state34() {
    ap_predicate_op154_write_state34 = (esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln879_reg_500.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln887_2_reg_573.read()));
}
...
void mis_hls::thread_child_ts_V_fu_369_p1() {
    child_ts_V_fu_369_p1 = task_in.read().range(32-1, 0);
}

void mis_hls::thread_empty_8_fu_320_p2() {
    empty_8_fu_320_p2 = (!zext_ln177_1_fu_314_p1.read().is_01() || !empty_fu_317_p1.read().is_01())? sc_lv<1>(): (sc_bigint<34>(zext_ln177_1_fu_314_p1.read()) > sc_bigint<34>(empty_fu_317_p1.read()));
}

void mis_hls::thread_empty_9_fu_326_p2() {
    empty_9_fu_326_p2 = (!start_n_V_reg_516.read().is_01() || !ap_const_lv32_7.is_01())? sc_lv<32>(): (sc_bigint<32>(start_n_V_reg_516.read()) + sc_biguint<32>(ap_const_lv32_7));
}

void mis_hls::thread_empty_fu_317_p1() {
    empty_fu_317_p1 = esl_sext<34,32>(start_n_V_reg_516.read());
}

void mis_hls::thread_grp_fu_364_ce() {
...
void mis_hls::thread_grp_fu_364_p0() {
    grp_fu_364_p0 =  (sc_lv<32>) (lhs_V_2_reg_551.read());
}

void mis_hls::thread_grp_fu_364_p1() {
    grp_fu_364_p1 =  (sc_lv<32>) (grp_fu_364_p10.read());
}

void mis_hls::thread_grp_fu_364_p10() {
    grp_fu_364_p10 = esl_zext<64,32>(total_v_V.read());
}

void mis_hls::thread_i_V_fu_305_p4() {
    i_V_fu_305_p4 = task_in.read().range(131, 100);
}

void mis_hls::thread_icmp_ln879_fu_243_p2() {
    icmp_ln879_fu_243_p2 = (!task_in_ttype_V_load_fu_234_p4.read().is_01() || !ap_const_lv4_4.is_01())? sc_lv<1>(): sc_lv<1>(task_in_ttype_V_load_fu_234_p4.read() == ap_const_lv4_4);
}

void mis_hls::thread_icmp_ln887_1_fu_351_p2() {
    icmp_ln887_1_fu_351_p2 = (!t_V_reg_175.read().is_01() || !n_V_reg_534.read().is_01())? sc_lv<1>(): (sc_bigint<32>(t_V_reg_175.read()) < sc_bigint<32>(n_V_reg_534.read()));
}

void mis_hls::thread_icmp_ln887_2_fu_372_p2() {
    icmp_ln887_2_fu_372_p2 = (!ngh_cnt_V_reg_545.read().is_01() || !n_V_reg_534.read().is_01())? sc_lv<1>(): (sc_bigint<32>(ngh_cnt_V_reg_545.read()) < sc_bigint<32>(n_V_reg_534.read()));
}

void mis_hls::thread_icmp_ln887_fu_346_p2() {
    icmp_ln887_fu_346_p2 = (!sext_ln887_fu_342_p1.read().is_01() || !zext_ln177_1_reg_540.read().is_01())? sc_lv<1>(): (sc_bigint<34>(sext_ln887_fu_342_p1.read()) < sc_bigint<34>(zext_ln177_1_reg_540.read()));
}

void mis_hls::thread_initialized_V_load_load_fu_185_p1() {
    initialized_V_load_load_fu_185_p1 = initialized_V.read();
}

void mis_hls::thread_l1_V_ARADDR() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state25.read()) && 
         esl_seteq<1,1,1>(l1_V_ARREADY.read(), ap_const_logic_1))) {
        l1_V_ARADDR = l1_V_addr_4_reg_592.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state11.read()) && 
                esl_seteq<1,1,1>(l1_V_ARREADY.read(), ap_const_logic_1))) {
        l1_V_ARADDR = l1_V_addr_3_reg_510.read();
...
void mis_hls::thread_l1_V_RREADY() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state18.read()) && 
         ...
         (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read()) && 
          esl_seteq<1,1,1>(ap_const_lv1_0, initialized_V_load_reg_478.read()) && 
          !(esl_seteq<1,1,1>(ap_const_lv1_0, initialized_V_load_reg_478.read()) && esl_seteq<1,1,1>(ap_const_logic_0, l1_V_RVALID.read()))) || 
...
void mis_hls::thread_lhs_V_2_fu_338_p1() {
    lhs_V_2_fu_338_p1 = esl_zext<64,32>(i_V_fu_305_p4.read());
}

void mis_hls::thread_lhs_V_fu_262_p1() {
    lhs_V_fu_262_p1 = esl_sext<34,32>(base_degree_V.read());
}

void mis_hls::thread_ngh_cnt_V_1_fu_462_p2() {
    ngh_cnt_V_1_fu_462_p2 = (!t_V_reg_175.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_bigint<32>(t_V_reg_175.read()) + sc_biguint<32>(ap_const_lv32_1));
}

void mis_hls::thread_ngh_cnt_V_fu_331_p3() {
    ngh_cnt_V_fu_331_p3 = (!empty_8_fu_320_p2.read()[0].is_01())? sc_lv<32>(): ((empty_8_fu_320_p2.read()[0].to_bool())? empty_9_fu_326_p2.read(): start_n_V_reg_516.read());
}

void mis_hls::thread_p_Result_s_fu_429_p5() {
    p_Result_s_fu_429_p5 = esl_partset<64,64,32,32,32>(p_Val2_s_fu_98.read(), l1_V_RDATA.read(), ap_const_lv32_0, ap_const_lv32_1F);
}

void mis_hls::thread_ret_V_1_fu_299_p2() {
    ret_V_1_fu_299_p2 = (!zext_ln177_fu_295_p1.read().is_01() || !ap_const_lv33_7.is_01())? sc_lv<33>(): (sc_biguint<33>(zext_ln177_fu_295_p1.read()) + sc_biguint<33>(ap_const_lv33_7));
}

void mis_hls::thread_ret_V_fu_270_p2() {
    ret_V_fu_270_p2 = (!lhs_V_fu_262_p1.read().is_01() || !rhs_V_fu_266_p1.read().is_01())? sc_lv<34>(): (sc_bigint<34>(lhs_V_fu_262_p1.read()) + sc_biguint<34>(rhs_V_fu_266_p1.read()));
}

void mis_hls::thread_rhs_V_fu_266_p1() {
    rhs_V_fu_266_p1 = esl_zext<34,32>(vid_V_fu_249_p4.read());
}

void mis_hls::thread_sext_ln177_1_fu_389_p1() {
    sext_ln177_1_fu_389_p1 = esl_sext<136,132>(tmp_1_fu_379_p5.read());
}

void mis_hls::thread_sext_ln177_fu_452_p1() {
    sext_ln177_fu_452_p1 = esl_sext<136,132>(tmp_fu_441_p5.read());
}

void mis_hls::thread_sext_ln544_1_fu_398_p1() {
    sext_ln544_1_fu_398_p1 = esl_sext<33,32>(base_neighbor_V.read());
}

void mis_hls::thread_sext_ln544_2_fu_402_p1() {
    sext_ln544_2_fu_402_p1 = esl_sext<33,32>(t_V_reg_175.read());
}

void mis_hls::thread_sext_ln544_3_fu_412_p1() {
    sext_ln544_3_fu_412_p1 = esl_sext<64,33>(add_ln544_reg_587.read());
}

void mis_hls::thread_sext_ln544_fu_276_p1() {
    sext_ln544_fu_276_p1 = esl_sext<64,34>(ret_V_fu_270_p2.read());
}

void mis_hls::thread_sext_ln887_fu_342_p1() {
    sext_ln887_fu_342_p1 = esl_sext<34,32>(t_V_reg_175.read());
}

void mis_hls::thread_start_n_V_fu_286_p4() {
    start_n_V_fu_286_p4 = task_in.read().range(99, 68);
}

void mis_hls::thread_task_in_ttype_V_load_fu_234_p4() {
    task_in_ttype_V_load_fu_234_p4 = task_in.read().range(67, 64);
}

void mis_hls::thread_task_out_V_TDATA_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state32.read()) || 
         (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state33.read()) && 
          esl_seteq<1,1,1>(icmp_ln887_1_reg_559.read(), ap_const_lv1_1)) || 
         (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state19.read()) && 
          esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln887_fu_346_p2.read()) && 
          esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln887_2_fu_372_p2.read())) || 
         (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state34.read()) && 
          esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln879_reg_500.read()) && 
          esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln887_2_reg_573.read())))) {
...
void mis_hls::thread_task_out_V_TDATA_int() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state32.read()) && 
         esl_seteq<1,1,1>(l1_V_RVALID.read(), ap_const_logic_1))) {
        task_out_V_TDATA_int = sext_ln177_fu_452_p1.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state19.read()) && 
                esl_seteq<1,1,1>(ap_const_boolean_1, ap_predicate_op124_write_state19.read()))) {
        task_out_V_TDATA_int = sext_ln177_1_fu_389_p1.read();
    } else {
...
void mis_hls::thread_tmp_1_fu_379_p5() {
    tmp_1_fu_379_p5 = esl_concat<68,64>(esl_concat<64,4>(esl_concat<32,32>(i_V_reg_529.read(), ngh_cnt_V_reg_545.read()), ap_const_lv4_4), trunc_ln176_fu_376_p1.read());
}

void mis_hls::thread_tmp_fu_441_p5() {
    tmp_fu_441_p5 = esl_concat<100,32>(esl_concat<68,32>(esl_concat<64,4>(p_Result_s_fu_429_p5.read(), ap_const_lv4_1), l1_V_RDATA.read()), child_ts_V_reg_568.read());
}

void mis_hls::thread_trunc_ln176_fu_376_p1() {
    trunc_ln176_fu_376_p1 = task_in.read().range(64-1, 0);
}
...
void mis_hls::thread_vid_V_fu_249_p4() {
    vid_V_fu_249_p4 = task_in.read().range(63, 32);
}

void mis_hls::thread_zext_ln177_1_fu_314_p1() {
    zext_ln177_1_fu_314_p1 = esl_zext<34,33>(ret_V_1_reg_524.read());
}

void mis_hls::thread_zext_ln177_fu_295_p1() {
    zext_ln177_fu_295_p1 = esl_zext<33,32>(start_n_V_fu_286_p4.read());
}

void mis_hls::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state1_io.read())) && esl_seteq<1,1,1>(ap_const_lv1_1, initialized_V_load_load_fu_185_p1.read()))) {
        ...
        case 256 : 
            ...
            break;
        case 512 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read()) && !(esl_seteq<1,1,1>(ap_const_lv1_0, initialized_V_load_reg_478.read()) && esl_seteq<1,1,1>(ap_const_logic_0, l1_V_RVALID.read())) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln879_fu_243_p2.read()))) {
                ap_NS_fsm = ap_ST_fsm_state34;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read()) && !(esl_seteq<1,1,1>(ap_const_lv1_0, initialized_V_load_reg_478.read()) && esl_seteq<1,1,1>(ap_const_logic_0, l1_V_RVALID.read())) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln879_fu_243_p2.read()))) {
        ...
        case 262144 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state19.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln887_fu_346_p2.read()) && esl_seteq<1,1,1>(ap_block_state19_io.read(), ap_const_boolean_0))) {
                ap_NS_fsm = ap_ST_fsm_state34;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state19.read()) && esl_seteq<1,1,1>(ap_block_state19_io.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln887_fu_346_p2.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln887_1_fu_351_p2.read()))) {
                ap_NS_fsm = ap_ST_fsm_state33;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state19.read()) && esl_seteq<1,1,1>(ap_block_state19_io.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln887_fu_346_p2.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln887_1_fu_351_p2.read()))) {
