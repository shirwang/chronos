...
// ==============================================================
#ifndef __mis_enqueue_mul_3bkb__HH__
#define __mis_enqueue_mul_3bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mis_enqueue_mul_3bkb) {
    ...
    SC_CTOR(mis_enqueue_mul_3bkb):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
