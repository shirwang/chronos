...
architecture behav of mis_task is 
    ...
    "mis_task,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7k160t-fbg484-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.500000,HLS_SYN_LAT=22,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=796,HLS_SYN_LUT=947,HLS_VERSION=2019_2}";
    ...
    signal initialized_V_load_load_fu_149_p1 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal vid_V_fu_172_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal vid_V_reg_281 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state9 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state9 : signal is "none";
    signal base_flags_V_load_reg_287 : STD_LOGIC_VECTOR (31 downto 0);
    signal l1_V_addr_1_reg_292 : STD_LOGIC_VECTOR (31 downto 0);
    signal cur_flag_V_reg_305 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln879_fu_216_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state18 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state18 : signal is "none";
    signal add_ln1503_fu_233_p2 : STD_LOGIC_VECTOR (29 downto 0);
    signal add_ln1503_reg_314 : STD_LOGIC_VECTOR (29 downto 0);
    signal ap_block_state22_io : BOOLEAN;
    signal trunc_ln176_fu_239_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln176_reg_319 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state23_io : BOOLEAN;
    signal sext_ln544_fu_199_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal lhs_V_fu_185_p0 : STD_LOGIC_VECTOR (31 downto 0);
    signal lhs_V_fu_185_p1 : STD_LOGIC_VECTOR (33 downto 0);
    signal rhs_V_fu_189_p1 : STD_LOGIC_VECTOR (33 downto 0);
    signal ret_V_fu_193_p2 : STD_LOGIC_VECTOR (33 downto 0);
    signal trunc_ln1503_fu_221_p1 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_2_fu_224_p4 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_1_fu_252_p4 : STD_LOGIC_VECTOR (131 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_const_boolean_1 = ap_block_state22_io) or (l1_V_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state22) and (icmp_ln879_reg_310 = ap_const_lv1_1))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state9)) then
                ...
                l1_V_addr_1_reg_292 <= sext_ln544_fu_199_p1(32 - 1 downto 0);
                vid_V_reg_281 <= task_in(63 downto 32);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((l1_V_RVALID = ap_const_logic_0) or (l1_V_WREADY = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state17))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, initialized_V, ap_CS_fsm_state23, ap_CS_fsm_state24, initialized_V_load_load_fu_149_p1, ap_CS_fsm_state8, ap_CS_fsm_state10, ap_CS_fsm_state17, ap_CS_fsm_state22, icmp_ln879_reg_310, ap_CS_fsm_state28, ap_CS_fsm_state16, l1_V_AWREADY, l1_V_WREADY, l1_V_ARREADY, l1_V_RVALID, l1_V_BVALID, ap_block_state1_io, ap_block_state22_io, ap_block_state23_io, regslice_both_task_out_V_U_apdone_blk, regslice_both_undo_log_entry_V_U_apdone_blk, ap_block_state24_io)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((ap_const_boolean_1 = ap_block_state1_io) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1) and (initialized_V_load_load_fu_149_p1 = ap_const_lv1_1))) then
            ...
            when ap_ST_fsm_state16 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state16) and (l1_V_AWREADY = ap_const_logic_1))) then
            ...
            when ap_ST_fsm_state22 => 
                if ((not(((ap_const_boolean_1 = ap_block_state22_io) or (l1_V_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state22) and (icmp_ln879_reg_310 = ap_const_lv1_0))) then
                    ap_NS_fsm <= ap_ST_fsm_state28;
                elsif ((not(((ap_const_boolean_1 = ap_block_state22_io) or (l1_V_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state22) and (icmp_ln879_reg_310 = ap_const_lv1_1))) then
            ...
            when ap_ST_fsm_state28 => 
                if ((not(((regslice_both_undo_log_entry_V_U_apdone_blk = ap_const_logic_1) or (regslice_both_task_out_V_U_apdone_blk = ap_const_logic_1) or ((l1_V_BVALID = ap_const_logic_0) and (icmp_ln879_reg_310 = ap_const_lv1_1)))) and (ap_const_logic_1 = ap_CS_fsm_state28))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state28;
                end if;
    ...
    add_ln1503_fu_233_p2 <= std_logic_vector(unsigned(trunc_ln1503_fu_221_p1) + unsigned(tmp_2_fu_224_p4));
    ...
    ap_block_state22_io_assign_proc : process(icmp_ln879_reg_310, l1_V_AWREADY)
    begin
                ap_block_state22_io <= ((l1_V_AWREADY = ap_const_logic_0) and (icmp_ln879_reg_310 = ap_const_lv1_1));
    end process;


    ap_block_state23_io_assign_proc : process(l1_V_WREADY, task_out_V_TREADY_int, undo_log_entry_V_TREADY_int)
    begin
                ap_block_state23_io <= ((undo_log_entry_V_TREADY_int = ap_const_logic_0) or (task_out_V_TREADY_int = ap_const_logic_0) or (l1_V_WREADY = ap_const_logic_0));
    end process;


    ap_block_state24_io_assign_proc : process(task_out_V_TREADY_int, undo_log_entry_V_TREADY_int)
    begin
                ap_block_state24_io <= ((undo_log_entry_V_TREADY_int = ap_const_logic_0) or (task_out_V_TREADY_int = ap_const_logic_0));
    end process;


    ap_block_state28_assign_proc : process(icmp_ln879_reg_310, l1_V_BVALID, regslice_both_task_out_V_U_apdone_blk, regslice_both_undo_log_entry_V_U_apdone_blk)
    begin
                ap_block_state28 <= ((regslice_both_undo_log_entry_V_U_apdone_blk = ap_const_logic_1) or (regslice_both_task_out_V_U_apdone_blk = ap_const_logic_1) or ((l1_V_BVALID = ap_const_logic_0) and (icmp_ln879_reg_310 = ap_const_lv1_1)));
    end process;


    ap_done_assign_proc : process(icmp_ln879_reg_310, ap_CS_fsm_state28, l1_V_BVALID, regslice_both_task_out_V_U_apdone_blk, regslice_both_undo_log_entry_V_U_apdone_blk)
    begin
        if ((not(((regslice_both_undo_log_entry_V_U_apdone_blk = ap_const_logic_1) or (regslice_both_task_out_V_U_apdone_blk = ap_const_logic_1) or ((l1_V_BVALID = ap_const_logic_0) and (icmp_ln879_reg_310 = ap_const_lv1_1)))) and (ap_const_logic_1 = ap_CS_fsm_state28))) then 
    ...
    ap_ready_assign_proc : process(icmp_ln879_reg_310, ap_CS_fsm_state28, l1_V_BVALID, regslice_both_task_out_V_U_apdone_blk, regslice_both_undo_log_entry_V_U_apdone_blk)
    begin
        if ((not(((regslice_both_undo_log_entry_V_U_apdone_blk = ap_const_logic_1) or (regslice_both_task_out_V_U_apdone_blk = ap_const_logic_1) or ((l1_V_BVALID = ap_const_logic_0) and (icmp_ln879_reg_310 = ap_const_lv1_1)))) and (ap_const_logic_1 = ap_CS_fsm_state28))) then 
    ...
    icmp_ln879_fu_216_p2 <= "1" when (cur_flag_V_reg_305 = ap_const_lv32_0) else "0";
    initialized_V_load_load_fu_149_p1 <= initialized_V;

    l1_V_ARADDR_assign_proc : process(ap_start, ap_CS_fsm_state1, initialized_V, ap_CS_fsm_state10, l1_V_ARREADY, ap_block_state1_io, l1_V_addr_1_reg_292)
    begin
        if (((l1_V_ARREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state10))) then 
    ...
    l1_V_AWADDR_assign_proc : process(ap_CS_fsm_state22, icmp_ln879_reg_310, ap_CS_fsm_state16, l1_V_AWREADY, l1_V_BVALID, l1_V_addr_1_reg_292, ap_block_state22_io)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state16) and (l1_V_AWREADY = ap_const_logic_1))) then 
            l1_V_AWADDR <= ap_const_lv64_80B(32 - 1 downto 0);
        elsif ((not(((ap_const_boolean_1 = ap_block_state22_io) or (l1_V_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state22) and (icmp_ln879_reg_310 = ap_const_lv1_1))) then 
    ...
    l1_V_AWVALID_assign_proc : process(ap_CS_fsm_state22, icmp_ln879_reg_310, ap_CS_fsm_state16, l1_V_AWREADY, l1_V_BVALID, ap_block_state22_io)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state16) and (l1_V_AWREADY = ap_const_logic_1)) or (not(((ap_const_boolean_1 = ap_block_state22_io) or (l1_V_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state22) and (icmp_ln879_reg_310 = ap_const_lv1_1)))) then 
    ...
    l1_V_BREADY_assign_proc : process(ap_CS_fsm_state22, icmp_ln879_reg_310, ap_CS_fsm_state28, l1_V_BVALID, ap_block_state22_io, regslice_both_task_out_V_U_apdone_blk, regslice_both_undo_log_entry_V_U_apdone_blk)
    begin
        if (((not(((regslice_both_undo_log_entry_V_U_apdone_blk = ap_const_logic_1) or (regslice_both_task_out_V_U_apdone_blk = ap_const_logic_1) or ((l1_V_BVALID = ap_const_logic_0) and (icmp_ln879_reg_310 = ap_const_lv1_1)))) and (ap_const_logic_1 = ap_CS_fsm_state28) and (icmp_ln879_reg_310 = ap_const_lv1_1)) or (not(((ap_const_boolean_1 = ap_block_state22_io) or (l1_V_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state22)))) then 
    ...
    l1_V_RREADY_assign_proc : process(ap_CS_fsm_state8, ap_CS_fsm_state17, l1_V_WREADY, l1_V_RVALID)
    begin
        if (((not(((l1_V_RVALID = ap_const_logic_0) or (l1_V_WREADY = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state17)) or ((l1_V_RVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state8)))) then 
    ...
    l1_V_WDATA_assign_proc : process(ap_CS_fsm_state23, ap_CS_fsm_state17, l1_V_RVALID, vid_V_reg_281)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state23)) then 
            l1_V_WDATA <= ap_const_lv32_1;
        elsif (((l1_V_RVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state17))) then 
    ...
    l1_V_WVALID_assign_proc : process(ap_CS_fsm_state23, ap_CS_fsm_state17, l1_V_WREADY, l1_V_RVALID, ap_block_state23_io)
    begin
        if (((not(((l1_V_RVALID = ap_const_logic_0) or (l1_V_WREADY = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state17)) or ((ap_const_boolean_0 = ap_block_state23_io) and (ap_const_logic_1 = ap_CS_fsm_state23)))) then 
    ...
    l1_V_blk_n_AW_assign_proc : process(m_axi_l1_V_AWREADY, ap_CS_fsm_state22, icmp_ln879_reg_310, ap_CS_fsm_state16)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state16) or ((ap_const_logic_1 = ap_CS_fsm_state22) and (icmp_ln879_reg_310 = ap_const_lv1_1)))) then 
    ...
    l1_V_blk_n_B_assign_proc : process(m_axi_l1_V_BVALID, ap_CS_fsm_state22, icmp_ln879_reg_310, ap_CS_fsm_state28)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state22) or ((ap_const_logic_1 = ap_CS_fsm_state28) and (icmp_ln879_reg_310 = ap_const_lv1_1)))) then 
    ...
    l1_V_blk_n_W_assign_proc : process(m_axi_l1_V_WREADY, ap_CS_fsm_state23, ap_CS_fsm_state17)
    begin
    ...
    lhs_V_fu_185_p0 <= base_flags_V;
        lhs_V_fu_185_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(lhs_V_fu_185_p0),34));

    ret_V_fu_193_p2 <= std_logic_vector(signed(lhs_V_fu_185_p1) + signed(rhs_V_fu_189_p1));
    rhs_V_fu_189_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(vid_V_fu_172_p4),34));
        sext_ln544_fu_199_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(ret_V_fu_193_p2),64));


    task_out_V_TDATA_blk_n_assign_proc : process(ap_CS_fsm_state23, ap_CS_fsm_state24, task_out_V_TREADY_int)
    begin
        ...
        task_out_V_TDATA_int <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_1_fu_252_p4),136));

    task_out_V_TVALID <= regslice_both_task_out_V_U_vld_out;

    task_out_V_TVALID_int_assign_proc : process(ap_CS_fsm_state23, ap_block_state23_io)
    begin
        if (((ap_const_boolean_0 = ap_block_state23_io) and (ap_const_logic_1 = ap_CS_fsm_state23))) then 
    ...
    tmp_1_fu_252_p4 <= ((vid_V_reg_281 & ap_const_lv36_4) & trunc_ln176_reg_319);
    tmp_2_fu_224_p4 <= task_in(61 downto 32);
    trunc_ln1503_fu_221_p1 <= base_flags_V_load_reg_287(30 - 1 downto 0);
    trunc_ln176_fu_239_p1 <= task_in(64 - 1 downto 0);

    undo_log_entry_V_TDATA_blk_n_assign_proc : process(ap_CS_fsm_state23, ap_CS_fsm_state24, undo_log_entry_V_TREADY_int)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state24) or (ap_const_logic_1 = ap_CS_fsm_state23))) then 
    ...
    undo_log_entry_V_TDATA_int <= ((ap_const_lv32_0 & add_ln1503_reg_314) & ap_const_lv2_0);
    undo_log_entry_V_TVALID <= regslice_both_undo_log_entry_V_U_vld_out;

    undo_log_entry_V_TVALID_int_assign_proc : process(ap_CS_fsm_state23, ap_block_state23_io)
    begin
        if (((ap_const_boolean_0 = ap_block_state23_io) and (ap_const_logic_1 = ap_CS_fsm_state23))) then 
    ...
    vid_V_fu_172_p4 <= task_in(63 downto 32);
end behav;
