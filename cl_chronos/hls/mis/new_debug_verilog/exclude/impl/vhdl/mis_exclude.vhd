...
port (
    ...
    task_out_V_TDATA : IN STD_LOGIC_VECTOR (135 downto 0);
    task_out_V_TVALID : IN STD_LOGIC;
    task_out_V_TREADY : OUT STD_LOGIC;
...
architecture behav of mis_exclude is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "mis_exclude,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7k160t-fbg484-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.500000,HLS_SYN_LAT=23,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=735,HLS_SYN_LUT=940,HLS_VERSION=2019_2}";
    ...
    signal initialized_V_load_load_fu_138_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal l1_V_blk_n_R : STD_LOGIC;
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal initialized_V_load_reg_243 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln883_reg_282 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal ngh_V_reg_259 : STD_LOGIC_VECTOR (31 downto 0);
    signal base_flags_V_load_reg_264 : STD_LOGIC_VECTOR (31 downto 0);
    signal l1_V_addr_2_reg_269 : STD_LOGIC_VECTOR (31 downto 0);
    signal current_flag_V_reg_276 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln883_fu_205_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state23 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state23 : signal is "none";
    signal add_ln1503_fu_222_p2 : STD_LOGIC_VECTOR (29 downto 0);
    signal add_ln1503_reg_286 : STD_LOGIC_VECTOR (29 downto 0);
    signal ap_block_state25_io : BOOLEAN;
    signal sext_ln544_fu_195_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal regslice_both_undo_log_entry_V_U_apdone_blk : STD_LOGIC;
    signal ap_block_state30 : BOOLEAN;
    signal lhs_V_fu_182_p0 : STD_LOGIC_VECTOR (31 downto 0);
    signal lhs_V_fu_182_p1 : STD_LOGIC_VECTOR (33 downto 0);
    signal rhs_V_fu_186_p1 : STD_LOGIC_VECTOR (33 downto 0);
    signal ret_V_fu_189_p2 : STD_LOGIC_VECTOR (33 downto 0);
    signal trunc_ln1503_fu_210_p1 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_1_fu_213_p4 : STD_LOGIC_VECTOR (29 downto 0);
    ...
    signal regslice_both_task_out_V_U_ack_in : STD_LOGIC;
    ...
    component mis_exclude_l1_V_m_axi IS
    generic (
...
begin
    mis_exclude_l1_V_m_axi_U : component mis_exclude_l1_V_m_axi
    generic map (
        CONSERVATIVE => 0,
        USER_DW => 32,
        USER_AW => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state23) and (icmp_ln883_fu_205_p2 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((l1_V_AWREADY = ap_const_logic_0) or ((l1_V_RVALID = ap_const_logic_0) and (initialized_V_load_reg_243 = ap_const_lv1_0)))) and (ap_const_logic_1 = ap_CS_fsm_state8) and (initialized_V_load_reg_243 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((l1_V_BVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state14))) then
                base_flags_V_load_reg_264 <= base_flags_V;
                l1_V_addr_2_reg_269 <= sext_ln544_fu_195_p1(32 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((l1_V_RVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state22))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((l1_V_WREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state9))) then
                ngh_V_reg_259 <= task_in(99 downto 68);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, initialized_V, initialized_V_load_load_fu_138_p1, ap_CS_fsm_state8, initialized_V_load_reg_243, ap_CS_fsm_state9, ap_CS_fsm_state14, ap_CS_fsm_state15, ap_CS_fsm_state22, ap_CS_fsm_state24, ap_CS_fsm_state25, ap_CS_fsm_state30, icmp_ln883_reg_282, ap_CS_fsm_state26, l1_V_AWREADY, l1_V_WREADY, l1_V_ARREADY, l1_V_RVALID, l1_V_BVALID, ap_block_state1_io, icmp_ln883_fu_205_p2, ap_CS_fsm_state23, ap_block_state25_io, regslice_both_undo_log_entry_V_U_apdone_blk, undo_log_entry_V_TREADY_int)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((ap_const_boolean_1 = ap_block_state1_io) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1) and (initialized_V_load_load_fu_138_p1 = ap_const_lv1_1))) then
            ...
            when ap_ST_fsm_state8 => 
                if ((not(((l1_V_AWREADY = ap_const_logic_0) or ((l1_V_RVALID = ap_const_logic_0) and (initialized_V_load_reg_243 = ap_const_lv1_0)))) and (ap_const_logic_1 = ap_CS_fsm_state8))) then
            ...
            when ap_ST_fsm_state15 => 
                if (((l1_V_ARREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state15))) then
            ...
            when ap_ST_fsm_state23 => 
                if (((icmp_ln883_fu_205_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state23))) then
                    ap_NS_fsm <= ap_ST_fsm_state30;
                else
                    ap_NS_fsm <= ap_ST_fsm_state24;
                end if;
            when ap_ST_fsm_state24 => 
                if (((l1_V_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state24))) then
            ...
            when ap_ST_fsm_state26 => 
                if (((undo_log_entry_V_TREADY_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state26))) then
            ...
            when ap_ST_fsm_state30 => 
                if ((not(((regslice_both_undo_log_entry_V_U_apdone_blk = ap_const_logic_1) or ((l1_V_BVALID = ap_const_logic_0) and (icmp_ln883_reg_282 = ap_const_lv1_0)))) and (ap_const_logic_1 = ap_CS_fsm_state30))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state30;
                end if;
    ...
    add_ln1503_fu_222_p2 <= std_logic_vector(unsigned(trunc_ln1503_fu_210_p1) + unsigned(tmp_1_fu_213_p4));
    ...
    ap_block_state25_io_assign_proc : process(l1_V_WREADY, undo_log_entry_V_TREADY_int)
    begin
                ap_block_state25_io <= ((undo_log_entry_V_TREADY_int = ap_const_logic_0) or (l1_V_WREADY = ap_const_logic_0));
    end process;


    ap_block_state30_assign_proc : process(icmp_ln883_reg_282, l1_V_BVALID, regslice_both_undo_log_entry_V_U_apdone_blk)
    begin
                ap_block_state30 <= ((regslice_both_undo_log_entry_V_U_apdone_blk = ap_const_logic_1) or ((l1_V_BVALID = ap_const_logic_0) and (icmp_ln883_reg_282 = ap_const_lv1_0)));
    end process;


    ap_block_state8_assign_proc : process(initialized_V_load_reg_243, l1_V_RVALID)
    begin
                ap_block_state8 <= ((l1_V_RVALID = ap_const_logic_0) and (initialized_V_load_reg_243 = ap_const_lv1_0));
    end process;


    ap_done_assign_proc : process(ap_CS_fsm_state30, icmp_ln883_reg_282, l1_V_BVALID, regslice_both_undo_log_entry_V_U_apdone_blk)
    begin
        if ((not(((regslice_both_undo_log_entry_V_U_apdone_blk = ap_const_logic_1) or ((l1_V_BVALID = ap_const_logic_0) and (icmp_ln883_reg_282 = ap_const_lv1_0)))) and (ap_const_logic_1 = ap_CS_fsm_state30))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state30, icmp_ln883_reg_282, l1_V_BVALID, regslice_both_undo_log_entry_V_U_apdone_blk)
    begin
        if ((not(((regslice_both_undo_log_entry_V_U_apdone_blk = ap_const_logic_1) or ((l1_V_BVALID = ap_const_logic_0) and (icmp_ln883_reg_282 = ap_const_lv1_0)))) and (ap_const_logic_1 = ap_CS_fsm_state30))) then 
    ...
    icmp_ln883_fu_205_p2 <= "1" when (current_flag_V_reg_276 = ap_const_lv32_2) else "0";
    initialized_V_load_load_fu_138_p1 <= initialized_V;

    l1_V_ARADDR_assign_proc : process(ap_start, ap_CS_fsm_state1, initialized_V, ap_CS_fsm_state15, l1_V_ARREADY, ap_block_state1_io, l1_V_addr_2_reg_269)
    begin
        if (((l1_V_ARREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state15))) then 
    ...
    l1_V_ARVALID_assign_proc : process(ap_start, ap_CS_fsm_state1, initialized_V, ap_CS_fsm_state15, l1_V_ARREADY, ap_block_state1_io)
    begin
        if (((not(((ap_const_boolean_1 = ap_block_state1_io) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1) and (initialized_V = ap_const_lv1_0)) or ((l1_V_ARREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state15)))) then 
    ...
    l1_V_AWADDR_assign_proc : process(ap_CS_fsm_state8, initialized_V_load_reg_243, ap_CS_fsm_state24, l1_V_AWREADY, l1_V_RVALID, l1_V_addr_2_reg_269)
    begin
        if (((l1_V_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state24))) then 
            l1_V_AWADDR <= l1_V_addr_2_reg_269;
        elsif ((not(((l1_V_AWREADY = ap_const_logic_0) or ((l1_V_RVALID = ap_const_logic_0) and (initialized_V_load_reg_243 = ap_const_lv1_0)))) and (ap_const_logic_1 = ap_CS_fsm_state8))) then 
            l1_V_AWADDR <= ap_const_lv64_80A(32 - 1 downto 0);
        else 
    ...
    l1_V_AWVALID_assign_proc : process(ap_CS_fsm_state8, initialized_V_load_reg_243, ap_CS_fsm_state24, l1_V_AWREADY, l1_V_RVALID)
    begin
        if ((((l1_V_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state24)) or (not(((l1_V_AWREADY = ap_const_logic_0) or ((l1_V_RVALID = ap_const_logic_0) and (initialized_V_load_reg_243 = ap_const_lv1_0)))) and (ap_const_logic_1 = ap_CS_fsm_state8)))) then 
    ...
    l1_V_BREADY_assign_proc : process(ap_CS_fsm_state14, ap_CS_fsm_state30, icmp_ln883_reg_282, l1_V_BVALID, regslice_both_undo_log_entry_V_U_apdone_blk)
    begin
        if (((not(((regslice_both_undo_log_entry_V_U_apdone_blk = ap_const_logic_1) or ((l1_V_BVALID = ap_const_logic_0) and (icmp_ln883_reg_282 = ap_const_lv1_0)))) and (ap_const_logic_1 = ap_CS_fsm_state30) and (icmp_ln883_reg_282 = ap_const_lv1_0)) or ((l1_V_BVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state14)))) then 
    ...
    l1_V_RREADY_assign_proc : process(ap_CS_fsm_state8, initialized_V_load_reg_243, ap_CS_fsm_state22, l1_V_AWREADY, l1_V_RVALID)
    begin
        if ((((l1_V_RVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state22)) or (not(((l1_V_AWREADY = ap_const_logic_0) or ((l1_V_RVALID = ap_const_logic_0) and (initialized_V_load_reg_243 = ap_const_lv1_0)))) and (ap_const_logic_1 = ap_CS_fsm_state8) and (initialized_V_load_reg_243 = ap_const_lv1_0)))) then 
    ...
    l1_V_WDATA_assign_proc : process(task_in, ap_CS_fsm_state9, ap_CS_fsm_state25)
    begin
    ...
    l1_V_WVALID_assign_proc : process(ap_CS_fsm_state9, ap_CS_fsm_state25, l1_V_WREADY, ap_block_state25_io)
    begin
        if ((((ap_const_boolean_0 = ap_block_state25_io) and (ap_const_logic_1 = ap_CS_fsm_state25)) or ((l1_V_WREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state9)))) then 
    ...
    l1_V_blk_n_AR_assign_proc : process(ap_start, ap_CS_fsm_state1, m_axi_l1_V_ARREADY, initialized_V, ap_CS_fsm_state15)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state15) or ((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (initialized_V = ap_const_lv1_0)))) then 
    ...
    l1_V_blk_n_AW_assign_proc : process(m_axi_l1_V_AWREADY, ap_CS_fsm_state8, ap_CS_fsm_state24)
    begin
    ...
    l1_V_blk_n_B_assign_proc : process(m_axi_l1_V_BVALID, ap_CS_fsm_state14, ap_CS_fsm_state30, icmp_ln883_reg_282)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state14) or ((ap_const_logic_1 = ap_CS_fsm_state30) and (icmp_ln883_reg_282 = ap_const_lv1_0)))) then 
    ...
    l1_V_blk_n_R_assign_proc : process(m_axi_l1_V_RVALID, ap_CS_fsm_state8, initialized_V_load_reg_243, ap_CS_fsm_state22)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state22) or ((ap_const_logic_1 = ap_CS_fsm_state8) and (initialized_V_load_reg_243 = ap_const_lv1_0)))) then 
    ...
    l1_V_blk_n_W_assign_proc : process(m_axi_l1_V_WREADY, ap_CS_fsm_state9, ap_CS_fsm_state25)
    begin
    ...
    lhs_V_fu_182_p0 <= base_flags_V;
        lhs_V_fu_182_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(lhs_V_fu_182_p0),34));

    ret_V_fu_189_p2 <= std_logic_vector(signed(lhs_V_fu_182_p1) + signed(rhs_V_fu_186_p1));
    rhs_V_fu_186_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ngh_V_reg_259),34));
        sext_ln544_fu_195_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(ret_V_fu_189_p2),64));


    task_out_V_TREADY_assign_proc : process(task_out_V_TVALID, regslice_both_task_out_V_U_ack_in)
    begin
        if (((task_out_V_TVALID = ap_const_logic_1) and (regslice_both_task_out_V_U_ack_in = ap_const_logic_1))) then 
    ...
    tmp_1_fu_213_p4 <= task_in(97 downto 68);
    trunc_ln1503_fu_210_p1 <= base_flags_V_load_reg_264(30 - 1 downto 0);

    undo_log_entry_V_TDATA_blk_n_assign_proc : process(ap_CS_fsm_state25, ap_CS_fsm_state26, undo_log_entry_V_TREADY_int)
    begin
    ...
    undo_log_entry_V_TDATA_int <= ((current_flag_V_reg_276 & add_ln1503_reg_286) & ap_const_lv2_0);
    undo_log_entry_V_TVALID <= regslice_both_undo_log_entry_V_U_vld_out;

    undo_log_entry_V_TVALID_int_assign_proc : process(ap_CS_fsm_state25, ap_block_state25_io)
    begin
        if (((ap_const_boolean_0 = ap_block_state25_io) and (ap_const_logic_1 = ap_CS_fsm_state25))) then 
