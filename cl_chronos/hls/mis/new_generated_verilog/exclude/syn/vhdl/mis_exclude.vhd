...
architecture behav of mis_exclude is 
    ...
    "mis_exclude,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7k160t-fbg484-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.500000,HLS_SYN_LAT=18,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=697,HLS_SYN_LUT=884,HLS_VERSION=2019_2}";
    ...
    signal initialized_V_load_load_fu_120_p1 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln883_reg_245 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal base_flags_V_load_reg_227 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state9 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state9 : signal is "none";
    signal l1_V_addr_1_reg_232 : STD_LOGIC_VECTOR (31 downto 0);
    signal current_flag_V_reg_239 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln883_fu_180_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state18 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state18 : signal is "none";
    signal add_ln1503_fu_197_p2 : STD_LOGIC_VECTOR (29 downto 0);
    signal add_ln1503_reg_249 : STD_LOGIC_VECTOR (29 downto 0);
    signal ap_block_state20_io : BOOLEAN;
    signal sext_ln544_fu_170_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal regslice_both_undo_log_entry_V_U_apdone_blk : STD_LOGIC;
    signal ap_block_state25 : BOOLEAN;
    signal lhs_V_fu_156_p0 : STD_LOGIC_VECTOR (31 downto 0);
    signal ngh_V_fu_143_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal lhs_V_fu_156_p1 : STD_LOGIC_VECTOR (33 downto 0);
    signal rhs_V_fu_160_p1 : STD_LOGIC_VECTOR (33 downto 0);
    signal ret_V_fu_164_p2 : STD_LOGIC_VECTOR (33 downto 0);
    signal trunc_ln1503_fu_185_p1 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_1_fu_188_p4 : STD_LOGIC_VECTOR (29 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state18) and (icmp_ln883_fu_180_p2 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state9)) then
                ...
                l1_V_addr_1_reg_232 <= sext_ln544_fu_170_p1(32 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, initialized_V, initialized_V_load_load_fu_120_p1, ap_CS_fsm_state8, ap_CS_fsm_state10, ap_CS_fsm_state17, ap_CS_fsm_state19, ap_CS_fsm_state20, ap_CS_fsm_state25, icmp_ln883_reg_245, ap_CS_fsm_state21, l1_V_AWREADY, l1_V_ARREADY, l1_V_RVALID, l1_V_BVALID, ap_block_state1_io, icmp_ln883_fu_180_p2, ap_CS_fsm_state18, ap_block_state20_io, regslice_both_undo_log_entry_V_U_apdone_blk, undo_log_entry_V_TREADY_int)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((ap_const_boolean_1 = ap_block_state1_io) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1) and (initialized_V_load_load_fu_120_p1 = ap_const_lv1_1))) then
            ...
            when ap_ST_fsm_state18 => 
                if (((icmp_ln883_fu_180_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state18))) then
            ...
            when ap_ST_fsm_state21 => 
                if (((undo_log_entry_V_TREADY_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state21))) then
            ...
            when ap_ST_fsm_state25 => 
                if ((not(((regslice_both_undo_log_entry_V_U_apdone_blk = ap_const_logic_1) or ((l1_V_BVALID = ap_const_logic_0) and (icmp_ln883_reg_245 = ap_const_lv1_0)))) and (ap_const_logic_1 = ap_CS_fsm_state25))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state25;
                end if;
    ...
    add_ln1503_fu_197_p2 <= std_logic_vector(unsigned(trunc_ln1503_fu_185_p1) + unsigned(tmp_1_fu_188_p4));
    ...
    ap_block_state20_io_assign_proc : process(l1_V_WREADY, undo_log_entry_V_TREADY_int)
    begin
                ap_block_state20_io <= ((undo_log_entry_V_TREADY_int = ap_const_logic_0) or (l1_V_WREADY = ap_const_logic_0));
    end process;


    ap_block_state25_assign_proc : process(icmp_ln883_reg_245, l1_V_BVALID, regslice_both_undo_log_entry_V_U_apdone_blk)
    begin
                ap_block_state25 <= ((regslice_both_undo_log_entry_V_U_apdone_blk = ap_const_logic_1) or ((l1_V_BVALID = ap_const_logic_0) and (icmp_ln883_reg_245 = ap_const_lv1_0)));
    end process;


    ap_done_assign_proc : process(ap_CS_fsm_state25, icmp_ln883_reg_245, l1_V_BVALID, regslice_both_undo_log_entry_V_U_apdone_blk)
    begin
        if ((not(((regslice_both_undo_log_entry_V_U_apdone_blk = ap_const_logic_1) or ((l1_V_BVALID = ap_const_logic_0) and (icmp_ln883_reg_245 = ap_const_lv1_0)))) and (ap_const_logic_1 = ap_CS_fsm_state25))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state25, icmp_ln883_reg_245, l1_V_BVALID, regslice_both_undo_log_entry_V_U_apdone_blk)
    begin
        if ((not(((regslice_both_undo_log_entry_V_U_apdone_blk = ap_const_logic_1) or ((l1_V_BVALID = ap_const_logic_0) and (icmp_ln883_reg_245 = ap_const_lv1_0)))) and (ap_const_logic_1 = ap_CS_fsm_state25))) then 
    ...
    icmp_ln883_fu_180_p2 <= "1" when (current_flag_V_reg_239 = ap_const_lv32_2) else "0";
    initialized_V_load_load_fu_120_p1 <= initialized_V;

    l1_V_ARADDR_assign_proc : process(ap_start, ap_CS_fsm_state1, initialized_V, ap_CS_fsm_state10, l1_V_ARREADY, ap_block_state1_io, l1_V_addr_1_reg_232)
    begin
        if (((l1_V_ARREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state10))) then 
    ...
    l1_V_BREADY_assign_proc : process(ap_CS_fsm_state25, icmp_ln883_reg_245, l1_V_BVALID, regslice_both_undo_log_entry_V_U_apdone_blk)
    begin
        if ((not(((regslice_both_undo_log_entry_V_U_apdone_blk = ap_const_logic_1) or ((l1_V_BVALID = ap_const_logic_0) and (icmp_ln883_reg_245 = ap_const_lv1_0)))) and (ap_const_logic_1 = ap_CS_fsm_state25) and (icmp_ln883_reg_245 = ap_const_lv1_0))) then 
    ...
    l1_V_blk_n_B_assign_proc : process(m_axi_l1_V_BVALID, ap_CS_fsm_state25, icmp_ln883_reg_245)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state25) and (icmp_ln883_reg_245 = ap_const_lv1_0))) then 
    ...
    lhs_V_fu_156_p0 <= base_flags_V;
        lhs_V_fu_156_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(lhs_V_fu_156_p0),34));

    ngh_V_fu_143_p4 <= task_in(99 downto 68);
    ret_V_fu_164_p2 <= std_logic_vector(signed(lhs_V_fu_156_p1) + signed(rhs_V_fu_160_p1));
    rhs_V_fu_160_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ngh_V_fu_143_p4),34));
        sext_ln544_fu_170_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(ret_V_fu_164_p2),64));
    ...
    tmp_1_fu_188_p4 <= task_in(97 downto 68);
    trunc_ln1503_fu_185_p1 <= base_flags_V_load_reg_227(30 - 1 downto 0);
    ...
    undo_log_entry_V_TDATA_int <= ((current_flag_V_reg_239 & add_ln1503_reg_249) & ap_const_lv2_0);
