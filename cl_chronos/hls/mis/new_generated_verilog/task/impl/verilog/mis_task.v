...
reg    l1_V_blk_n_AR;
wire   [0:0] initialized_V_load_load_fu_131_p1;
reg    l1_V_blk_n_R;
...
wire   [31:0] vid_V_fu_154_p4;
reg   [31:0] vid_V_reg_256;
wire    ap_CS_fsm_state9;
reg  signed [31:0] base_flags_V_load_reg_261;
reg   [31:0] l1_V_addr_1_reg_266;
reg   [31:0] cur_flag_V_reg_273;
wire   [0:0] icmp_ln879_fu_191_p2;
wire    ap_CS_fsm_state18;
wire   [29:0] add_ln1503_fu_208_p2;
reg   [29:0] add_ln1503_reg_282;
wire   [63:0] trunc_ln176_fu_214_p1;
reg   [63:0] trunc_ln176_reg_287;
reg    ap_block_state20_io;
wire  signed [63:0] sext_ln544_fu_181_p1;
wire    regslice_both_task_out_V_U_apdone_blk;
wire    regslice_both_undo_log_entry_V_U_apdone_blk;
reg    ap_block_state25;
wire  signed [31:0] lhs_V_fu_167_p0;
wire  signed [33:0] lhs_V_fu_167_p1;
wire   [33:0] rhs_V_fu_171_p1;
wire   [33:0] ret_V_fu_175_p2;
wire   [29:0] trunc_ln1503_fu_196_p1;
wire   [29:0] tmp_2_fu_199_p4;
wire   [131:0] tmp_1_fu_227_p4;
reg   [24:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state18) & (icmp_ln879_fu_191_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        l1_V_addr_1_reg_266 <= sext_ln544_fu_181_p1;
        vid_V_reg_256 <= {{task_in[63:32]}};
    end
end
...
always @ (*) begin
    if ((~((regslice_both_undo_log_entry_V_U_apdone_blk == 1'b1) | (regslice_both_task_out_V_U_apdone_blk == 1'b1) | ((l1_V_BVALID == 1'b0) & (icmp_ln879_reg_278 == 1'd1))) & (1'b1 == ap_CS_fsm_state25))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((~((regslice_both_undo_log_entry_V_U_apdone_blk == 1'b1) | (regslice_both_task_out_V_U_apdone_blk == 1'b1) | ((l1_V_BVALID == 1'b0) & (icmp_ln879_reg_278 == 1'd1))) & (1'b1 == ap_CS_fsm_state25) & (icmp_ln879_reg_278 == 1'd1))) begin
        l1_V_BREADY = 1'b1;
    end else begin
        l1_V_BREADY = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state25) & (icmp_ln879_reg_278 == 1'd1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((1'b1 == ap_block_state1_io) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1) & (initialized_V_load_load_fu_131_p1 == 1'd1))) begin
        ...
        ap_ST_fsm_state18 : begin
            if (((1'b1 == ap_CS_fsm_state18) & (icmp_ln879_fu_191_p2 == 1'd0))) begin
...
assign add_ln1503_fu_208_p2 = (trunc_ln1503_fu_196_p1 + tmp_2_fu_199_p4);
...
always @ (*) begin
    ap_block_state20_io = ((undo_log_entry_V_TREADY_int == 1'b0) | (task_out_V_TREADY_int == 1'b0) | (l1_V_WREADY == 1'b0));
end

always @ (*) begin
    ap_block_state21_io = ((undo_log_entry_V_TREADY_int == 1'b0) | (task_out_V_TREADY_int == 1'b0));
end

always @ (*) begin
    ap_block_state25 = ((regslice_both_undo_log_entry_V_U_apdone_blk == 1'b1) | (regslice_both_task_out_V_U_apdone_blk == 1'b1) | ((l1_V_BVALID == 1'b0) & (icmp_ln879_reg_278 == 1'd1)));
end
...
assign icmp_ln879_fu_191_p2 = ((cur_flag_V_reg_273 == 32'd0) ? 1'b1 : 1'b0);

assign initialized_V_load_load_fu_131_p1 = initialized_V;

assign lhs_V_fu_167_p0 = base_flags_V;

assign lhs_V_fu_167_p1 = lhs_V_fu_167_p0;

assign ret_V_fu_175_p2 = ($signed(lhs_V_fu_167_p1) + $signed(rhs_V_fu_171_p1));

assign rhs_V_fu_171_p1 = vid_V_fu_154_p4;

assign sext_ln544_fu_181_p1 = $signed(ret_V_fu_175_p2);

assign task_out_V_TDATA_int = $signed(tmp_1_fu_227_p4);

assign task_out_V_TVALID = regslice_both_task_out_V_U_vld_out;

assign tmp_1_fu_227_p4 = {{{vid_V_reg_256}, {36'd4}}, {trunc_ln176_reg_287}};

assign tmp_2_fu_199_p4 = {{task_in[61:32]}};

assign trunc_ln1503_fu_196_p1 = base_flags_V_load_reg_261[29:0];

assign trunc_ln176_fu_214_p1 = task_in[63:0];

assign undo_log_entry_V_TDATA_int = {{{{32'd0}, {add_ln1503_reg_282}}}, {2'd0}};

assign undo_log_entry_V_TVALID = regslice_both_undo_log_entry_V_U_vld_out;

assign vid_V_fu_154_p4 = {{task_in[63:32]}};
